...
const Projects = async ({
  ...
  return (
    <div>
      <main className="w-full mx-auto text-black bg-white pt-[32px] pb-[30px] px-[16px]">
        ...
        <div className="flex items-center lg:flex-wrap flex-col lg:flex-row gap-[30px] lg:justify-center max-w-[1440px] mx-auto">
          {projects.map((item) => (
            <div key={item._id} className="w-[288px] md:w-[704px] lg:w-[641px]">
              ...
              <p className="mb-[16px] lg:mb-[20px] h-[160px] md:h-[170px] lg:h-[190px] overflow-y-auto">
              ...
              <div className="md:flex justify-between items-center mb-[30px]">
                ...
                <Button type="button" className="block py-[18px] px-[24px] mt-[8px] border-black">
