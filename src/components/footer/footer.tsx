      ...
      <div className="w-full flex flex-col flex-wrap md:flex-row items-center justify-center md:items-start lg:flex-nowrap lg:justify-between">
        <div className="w-full flex justify-center lg:w-[270px]">
          ...
          />
            ...
            <nav>
              <ul className="flex flex-col flex-wrap gap-y-[20px] md:flex-row md:gap-y-[30px] md:justify-stretch md:gap-x-[50px] md:w-[280px] text-center md:text-left md:justify-between text-[18px] lg:text-md leading-2 lg:leading-1 lg:font-medium">
            ...
            <ul className="text-center mt-[30px] md:mt-0 md:text-start text-[18px] lg:text-md leading-3">
        ...
        <a href="https://baza-trainee.tech/ua" target="_blank">
          <p className="lg:mx-[12px] mt-[50px] lg:mt-[26px] text-center lg:text-start text-base leading-3">
