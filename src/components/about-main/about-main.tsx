...
export const AboutMain = async ({ lng }: { lng: "en" | "uk" }) => {
  ...
  return (
    <section id="about-main" className="py-[72px] text-black bg-pink-pearl w-full">
      <div className="w-full mx-auto max-w-[1440px] px-4 flex justify-normal flex-col">
        <div className="flex lg:flex-row flex-col justify-between items-center pb-7 md:pb-10 lg:pb-14">
          <h2 className="h1 mr-5 lg:mb-0 mb-10 lg:self-auto self-start">{t("greeting")}</h2>
          <p className="leading-2 md:max-w-[950px] self-start md:text-md lg:text-xl">{t("text")}</p>
        </div>
